...
const RecordOfBarangayInhabitantsForm = ({ onBack }) => {
  ...
  return (
    <div className="min-h-screen bg-blue-50 font-sans">
      <header className="bg-white p-4 px-8 flex justify-between items-center shadow-md">
...
export default RecordOfBarangayInhabitantsForm;
